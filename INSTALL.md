...
```
$ sudo apt-get install git python-virtualenv libssl-dev libffi-dev build-essential libpython-dev python2.7-minimal authbind python-mysqldb libmysqlclient-dev
```
...
To enable telnet, for example, create `cowrie.cfg` as a copy of the file
`cowrie.cfg.dist`
